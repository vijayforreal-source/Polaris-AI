...
The project now includes the Checkpoint 5 time-dependent regional route planner, the Checkpoint 4 dynamic risk engine, plus the Checkpoint 3 sea-ice prediction engine, with **v0.3** selected
...
Routing is available for the Bharati / Prydz Bay regional study grid through +72H. It is research decision-support output, not certified navigation; continuous rerouting is deferred to Checkpoint 6.
