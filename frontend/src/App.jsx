    ...
    <main className="mission-shell">
      ...
      <section className="mission-stage">
        <div className="map-frame">
          {observation ? (
            <AntarcticMap metadata={observation.metadata} grid={observation.grid} />
          ) : (
          ...
          <div className="map-attribution">Sea ice: Copernicus Marine Service · OSI-SAF / EUMETSAT<br />Land: Natural Earth 1:110m</div>
        </div>
