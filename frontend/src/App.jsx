...
export default function App() {
  ...
  const renderView = () => {
    ...
    if (activeView === "forecast") return <UnavailableModule title="Sea-Ice Forecast Engine" description="Verified observed sea ice remains available in Mission Control. Future +6H to +72H forecast fields have not been implemented." />;
